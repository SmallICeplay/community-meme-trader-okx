          ...
          {SORTS.map(s => (
            <button
              ...
              className={clsx(
                ...
                sort === s.value ? 'bg-accent-indigo-20 text-indigo-400' : 'text-gray-500 hover:text-gray-300'
              )}
            >
              {s.label}
            </button>
          ...
          {LEADERBOARD_SORTS.map(s => (
            <button
              ...
              className={clsx(
                ...
                sortBy === s.key ? 'bg-accent-indigo-20 text-indigo-400' : 'text-gray-500 hover:text-gray-300'
              )}
            >
              {s.label}
            </button>
