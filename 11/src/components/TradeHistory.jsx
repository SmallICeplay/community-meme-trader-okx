      ...
      <div className="flex items-center justify-between mb-3">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-2 text-[11px]">
            ...
            <span className={clsx('font-mono font-semibold', summary.totalPnl >= 0 ? 'text-indigo-400' : 'text-accent-red')}>
            ...
            <span className={clsx('font-mono font-semibold', summary.totalNet >= 0 ? 'text-indigo-400' : 'text-accent-red')}>
                ...
                return (
                  <tr key={t.id} className="border-b border-dark-700 hover:bg-dark-700/30">
                    ...
                    <td className="text-right py-2 pr-3">
                      ...
                      <div className={t.pnl_pct >= 0 ? 'text-indigo-400' : 'text-accent-red'}>
                    ...
                    <td className="text-right py-2 pr-3">
                      <span className={clsx('font-mono font-semibold text-[11px]', netPnl >= 0 ? 'text-indigo-400' : 'text-red-400')}>
