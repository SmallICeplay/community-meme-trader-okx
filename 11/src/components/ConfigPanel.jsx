        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            <div className="flex items-center gap-2">
              <span className="text-xs font-medium text-gray-300">OKX Trade API</span>
              ...
              <div className="space-y-1.5">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-dark-700 border border-dark-500 rounded-lg px-3 py-2 text-xs text-gray-200 font-mono placeholder-gray-600 focus:outline-none focus:border-indigo-500"
                  />
                </div>
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-dark-700 border border-dark-500 rounded-lg px-3 py-2 text-xs text-gray-400 font-mono focus:outline-none focus:border-indigo-500"
                  />
                </div>
              </div>
            )}
            ...
            <div className={clsx('space-y-3', aiCfg.use_builtin && aiCfg.builtin_available ? 'opacity-50' : '')}>
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full bg-dark-700 border border-dark-500 rounded-lg px-3 py-2 text-xs text-gray-200 focus:outline-none focus:border-indigo-500"
                >
              ...
              <div>
                ...
                {(aiCfg.providers?.[aiCfg.provider]?.models || []).length > 0 ? (
                  ...
                  <input
                    ...
                    className="w-full bg-dark-700 border border-dark-500 rounded-lg px-3 py-2 text-xs text-gray-200 font-mono focus:outline-none focus:border-indigo-500"
                  />
                )}
              </div>
            ...
            <button
              ...
              className={clsx(
                ...
                aiSaved
                  ...
                  : 'bg-accent-indigo-80 hover:bg-indigo-500 text-white'
              )}
            >
              ...
              <button
                ...
                className={clsx(
                  ...
                  cfg.position_price_source === opt.value
                    ? 'border-indigo-500 bg-accent-indigo-10 text-indigo-400'
                ...
                <button
                  ...
                  className={clsx(
                    ...
                    cfg.filter_new_sender_action === opt.v
                      ? 'bg-accent-indigo-20 border-indigo-500 text-indigo-400'
            ...
            <div className={clsx('grid grid-cols-2 gap-2', !isEnabled('filter_market_cap_enabled') && 'opacity-40')}>
              <div>
                ...
                <input type="number" value={cfg.filter_market_cap_min}
                  ...
                  className="w-full bg-dark-700 border border-dark-500 rounded-lg px-3 py-2 text-sm text-gray-200 focus:outline-none focus:border-indigo-500 disabled:cursor-not-allowed" />
              </div>
              <div>
                    ...
                    className={clsx(
                      ...
                      cfg.broadcast_mode === m.val
                        ? m.val === 'direct'
                          ...
                          : 'border-accent-indigo-60 text-indigo-400 bg-accent-indigo-10'
                        : 'border-dark-500 text-gray-500 hover:text-gray-300'
                    )}
                  >
                    {m.label}
  ...
  return (
    <div className={clsx('flex items-center gap-3', !enabled && 'opacity-50')}>
      ...
      <input
        ...
        className="w-24 bg-dark-700 border border-dark-500 rounded-lg px-2 py-1 text-sm text-gray-200 focus:outline-none focus:border-indigo-500 disabled:cursor-not-allowed"
      />
  ...
  return (
    <div>
      ...
      <input
        ...
        max={max}
        step={step}
        className="w-full bg-dark-700 border border-dark-500 rounded-lg px-3 py-2 text-sm text-gray-200 focus:outline-none focus:border-indigo-500"
      />
    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        {[
          ...
          { label: '交易 P&L', value: `${((stats?.total_pnl_usdt || 0) >= 0 ? '+' : '') + (stats?.total_pnl_usdt || 0).toFixed(3)}U`, color: (stats?.total_pnl_usdt || 0) >= 0 ? 'text-indigo-400' : 'text-red-400' },
          { label: '净盈亏(含Gas)', value: `${totalNet >= 0 ? '+' : ''}${totalNet.toFixed(3)}U`, color: totalNet >= 0 ? 'text-indigo-400' : 'text-red-400' },
        ].map(s => (
        ...
        <div className="space-y-2">
          {Object.entries(byReason).sort((a, b) => b[1].totalGas - a[1].totalGas).map(([reason, d]) => (
            <div key={reason} className="flex items-center gap-3 text-xs">
              ...
              <span className={clsx('font-mono w-16 text-right', (d.totalPnl - d.totalGas) >= 0 ? 'text-indigo-400' : 'text-red-400')}>
          ...
          {shown.map(t => {
            ...
            return (
              <div key={t.id} className="flex items-center gap-2 text-xs group">
                ...
                <span className={clsx('font-mono w-16 text-right shrink-0', netPnl >= 0 ? 'text-indigo-400' : 'text-red-400')}>
