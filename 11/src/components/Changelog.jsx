...
买入：固定显示 ⚡ OKX Trade（蓝色）。
卖出：正常走 AVE Router 显示 OKX Trade，触发 DEX fallback 时显示 PancakeSwap Direct（黄色）。
...
const TYPE_CFG = {
  ...
  feat: { label: '新功能',   color: 'text-indigo-400', bg: 'bg-blue-900/20 border-blue-800/40' },
        ...
        return (
          <div key={release.version}>
            ...
            <div className="flex items-center gap-3 mb-3">
              <span className="text-xs font-bold text-indigo-400 bg-accent-indigo-10 border border-accent-indigo-30 px-2 py-0.5 rounded">
                {release.version}
              </span>
