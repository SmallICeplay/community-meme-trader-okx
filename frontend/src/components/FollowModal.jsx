          ...
          <div className="px-5 py-4 space-y-4">
            ...
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className={clsx(
                  ...
                  form.enabled ? 'bg-indigo-500' : 'bg-dark-600'
                )}
              >
                <span className={clsx(
            ...
            <div className="flex gap-2 pt-1">
              ...
              <button onClick={handleSave} disabled={saving}
                className="flex-1 py-2 text-xs rounded bg-accent-indigo-90 hover:bg-indigo-500 text-white font-medium transition-colors">
