    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70" onClick={onClose}>
      ...
      >
        ...
        <input
          ...
          placeholder="管理员密码"
          className="w-full bg-dark-700 border border-dark-500 text-gray-200 rounded-lg px-3 py-2 text-sm font-mono mb-3 focus:outline-none focus:border-indigo-500"
        />
        ...
        <div className="flex gap-2">
          ...
          <button
            ...
            className="flex-1 py-2 rounded-lg text-xs font-semibold bg-accent-indigo-80 hover:bg-indigo-500 text-white transition-colors disabled:opacity-40"
          >
            {loading ? '验证中...' : '登录'}
          </button>
        </div>
